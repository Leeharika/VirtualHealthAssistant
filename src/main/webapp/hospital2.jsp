...
<body>
  ...
  <ul class="collapse navbar-collapse justify-content-end">
	...
	<div class=="container">
		<br>
			<div>
				<h2 align="center">Hospital2</h2>
			</div>
		<br>
		<div>
			<center><img style="height: 400px;width:60%;" src="hospital2.jpg"></center>
		</div>
		<br>
		<div>
			<h3 align="center">Hospital Facilities and Services</h3>
			<p align="center" style="padding-left:80px;padding-right:80px;">Hospital2 Private Hospital is a 170 bed acute medical and advanced surgical hospital situated on the National Highway at Hyderabad. The hospital is owned and operated by VMedico Groups, the largest operator of private hospitals in India. Hospital2 Private Hospital provides private health care services to residents of the Hyderabad as well as the broader referral region of the Hyderabad. The hospital is a NSW Health Department licensed provider of Cardiothoracic surgery. The hospital is home to the Hunter Cancer Centre providing a private comprehensive oncology care in medical, surgical and radiation oncology.</p>
		</div>
		<br>			
		<div>
			<h3 align="center">Emergency Department</h3>
			<p align="center" style="padding-left:80px;padding-right:80px;">In April 2019 the Region&apos;s first Private Emergency Department was opened, providing another option for people requiring emergency care. The Emergency Department has 6 beds including a state of the art resuscitation room, triage room and procedure room. The enthusiastic team of emergency trained doctors and nurses provide prompt and professional care 24 hours a day, 365 days of the year.</p>
		</div>
		<div>
