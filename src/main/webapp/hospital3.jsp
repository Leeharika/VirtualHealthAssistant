...
<body>
  ...
  <ul class="collapse navbar-collapse justify-content-end">
	...
	<div class=="container">
		<br>
			<div>
				<h2 align="center">Hospital3</h2>
			</div>
		<br>
		<div>
			<center><img style="height: 400px;width:60%;" src="hospital3.jpg"></center>
		</div>
		<br>
		<div>
			<h3 align="center">Hospital Facilities and Services</h3>
			<p align="center" style="padding-left:80px;padding-right:80px;">Hospital3 Private Hospital is a 200 bed acute medical and advanced surgical hospital situated on the National Highway at Vijayawada. The hospital is owned and operated by VMedico Groups, the largest operator of private hospitals in India. Hospital3 Private Hospital provides private health care services to residents of the Vijayawada as well as the broader referral region of the Vijayawada. The hospital is a NSW Health Department licensed provider of Cardiothoracic surgery. The hospital is home to the Hunter Cancer Centre providing a private comprehensive oncology care in medical, surgical and radiation oncology.</p>
		</div>
		<br>			
		<div>
			<h3 align="center">Emergency Department</h3>
			<p align="center" style="padding-left:80px;padding-right:80px;">In January 1999 the Region&apos;s first Private Emergency Department was opened, providing another option for people requiring emergency care. The Emergency Department has 10 beds including a state of the art resuscitation room, triage room and procedure room. The enthusiastic team of emergency trained doctors and nurses provide prompt and professional care 24 hours a day, 365 days of the year.</p>
		</div>
		<div>
